...
subscribed_symbols2 = [
    ...
    # TATAMOTORS Options
    "NSE:TATAMOTORS25OCT600CE", "NSE:TATAMOTORS25OCT700CE",
    "NSE:TATAMOTORS25OCT600PE", "NSE:TATAMOTORS25OCT700PE",
    ...
    "MCX:LEAD25DECFUT",
    "MCX:NICKEL25DECFUT",
    "MCX:ALUMINIUM25DECFUT",
    
    # Energy Futures
    "MCX:CRUDEOIL25DECFUT",
    "MCX:NATURALGAS25DECFUT",
    
    # Agri Commodities Futures
    "MCX:COTTON25DECFUT", 
    "MCX:MENTHAOIL25DECFUT", 
    "MCX:CRUDEOIL25DECFUT", 
    
    # === MCX COMMODITIES - OPTIONS ===
    # Gold Options
    ...
    # Natural Gas Options
    "MCX:NATURALGAS25DEC280CE", "MCX:NATURALGAS25DEC300CE",
    "MCX:NATURALGAS25DEC280PE", "MCX:NATURALGAS25DEC300PE",
    
    # Copper Options
    "MCX:COPPER25DEC880CE", "MCX:COPPER25DEC900CE",
    "MCX:COPPER25DEC880PE", "MCX:COPPER25DEC900PE",
