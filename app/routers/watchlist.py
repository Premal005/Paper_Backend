...
# UPDATE_INTERVAL = 1  # 3 seconds between updates - much more frequent!
...
# # ============================================================== 
# async def update_all_watchlists_loop():
#     """Concurrent background updater"""
#     logger.info("🚀 Concurrent watchlist auto-updater started...")
#     while True:
#         try:
...
#     try:
#         loop.create_task(update_all_watchlists_loop())
#         logger.info("✅ Concurrent watchlist auto-update loop initialized.")
#     except Exception as e:
#         logger.error(f"Failed to start watchlist updater: {e}")
...
#     # Trigger immediate update for this user's watchlist
...
#     """Debug endpoint to check if updates are working"""
#     user_id = str(user["_id"])
#     watchlist = await Watchlist.find_by_user(user_id)
...
#         "recent_updates": recent_updates[:5],  # Show first 5
